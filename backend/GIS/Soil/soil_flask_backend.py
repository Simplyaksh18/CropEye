...
if __name__ == '__main__':
    print("=" * 80)
    print("🛰️  SOIL ANALYSIS BACKEND - FINAL VERSION")
    print("=" * 80)
    print("\n📍 API Endpoints:")
    ...
    print(f"🔗 NDVI module integration: {'✅ Active' if (ndvi_integration and ndvi_integration.is_available()) else '⚠️ Fallback'}")
    print(f"🛰️ Copernicus integration: {'✅ Active' if (soil_collector and soil_collector.copernicus_downloader) else '⚠️ Unavailable'}")
    print("\n" + "=" * 80 + "\n")
